package com.jingqiduizhang.netty.demo1.service;
...
public class ServerHandler extends ChannelInboundHandlerAdapter {
     ...
     * @throws Exception
     */
    //hannelHandlerContext就是ChannelHandler(处理数据的，数据的 接收是在这个里面处理的)上下文，因此它就可以看做是一个管理它所关联的ChannelHandler
    @Override
